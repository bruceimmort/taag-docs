...
Welcome once again... I hope until now you already have a rule for your plan.
...
So now let's say you made a typo and set a price which is not the one you wanted, we all do mistakes so it is normal!
...
- Here you can now change the price to the correct one for that country or even continent.
...
So you have created rule and now you are also able to edit the price. Now how about we [connect](../integration/connect) Taag with your application lastly to sync all together with you project.