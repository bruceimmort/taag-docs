...
And now I believe you did create at least a plan for your project maybe basic or another. But If you have not created any and need some help you can quickly do that just [click here](../plan) and come back after. 
...
You can remove the cotinent or the country you added by accident by clicking a small "X" on any continent or country card.
And set rule buy clicking the blue **"Set rule"** button... as easy as that.
...
<Columns cols={2}>
  ...
  <Card title="Remove" icon="trash" href="./delete">
    Get rid of the rules you do not need no more.
  </Card>
</Columns>